...
public class AwsBatchBuilder  extends Builder {
    ...
    public String getShareIdentifier() {return shareidentifier;}
    public Integer getSchedulingpriorityoverride() { return schedulingpriorityoverride;}
    ...
    private SubmitJobRequest getSubmitJobRequest() {
        SubmitJobRequest job = new SubmitJobRequest()
                ...
                .withSchedulingPriorityOverride(schedulingpriorityoverride)
    ...
    public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) throws AbortException, InterruptedException {
        ...
        BatchLogRetriever retriever = new BatchLogRetriever(listener.getLogger(), awsbatch, sjr.getJobId(), sjr.getJobName(), getDescriptor().logPollingFreq);
